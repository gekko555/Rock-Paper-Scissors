...
public class RockPaperScissorsGame extends JFrame {
    ...
    private String[] displayNames = { "グー", "パー", "チョキ" };
    ...
    private void initComponents() {
        ...
        streakLabel.setFont(new Font("MS Gothic", Font.BOLD, 20));
        ...
        computerChoiceLabel.setFont(new Font("MS Gothic", Font.BOLD, 16));
        ...
        resultLabel.setFont(new Font("MS Gothic", Font.BOLD, 18));
    ...
    private void playGame(String playerChoice) {
        ...
        // 相手の手をテキストと画像で表示
        String displayName = getDisplayName(currentComputerChoice);
        computerChoiceLabel.setText("相手の手: " + displayName);
    ...
    private String getDisplayName(String choice) {
        switch (choice) {
            case "rock":
                return "グー";
            case "paper":
